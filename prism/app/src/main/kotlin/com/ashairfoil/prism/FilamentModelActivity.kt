...
class FilamentModelActivity : ComponentActivity() {
    ...
    private val dancePresets = listOf(
        ...
        DancePreset("SQUAT SHAKE",  10f, 4, 0f,     3f,  4, 0f,      0.040f, 8, 0f,    SceneManager.DanceEase.LINEAR, 0.70f, 0.50f, 0.50f, 0.50f, 0.10f, 0.3f, 0.3f, 0.0f, 0.0f, 0.85f, 0.0f, null, true),
